...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4176__auto__,writer__4177__auto__,opt__4178__auto__){return cljs.core._write.call(null,writer__4177__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15302 = (0);while(true){
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4176__auto__,writer__4177__auto__,opt__4178__auto__){return cljs.core._write.call(null,writer__4177__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_15309 = (self__.level + (1));while(true){
if((i_15309 <= (new_level + (1))))
{(update[i_15309] = self__.header);
{
var G__15310 = (i_15309 + (1));
i_15309 = G__15310;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15311 = (0);while(true){
if((i_15311 <= self__.level))
{var links_15312 = (update[i_15311]).forward;if(((links_15312[i_15311]) === x__$1))
{(links_15312[i_15311] = (x__$1.forward[i_15311]));
{
var G__15313 = (i_15311 + (1));
i_15311 = G__15313;
continue;
}
} else
{{
var G__15314 = (i_15311 + (1));
i_15311 = G__15314;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3599__auto__ = (cljs.core.truth_((function (){var and__3587__auto__ = me;if(cljs.core.truth_(and__3587__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3587__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3599__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__3599__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__3599__auto__,timeout__$1,me))
,msecs);
